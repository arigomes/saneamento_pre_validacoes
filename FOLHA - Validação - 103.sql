...
select beneficiarios.i_funcionarios from bethadba.beneficiarios, bethadba.rescisoes, bethadba.funcionarios
...
and beneficiarios.i_entidades in (1,2,3,4)
...
where beneficiarios.i_entidades = rescisoes.i_entidades and beneficiarios.i_instituidor = rescisoes.i_funcionarios
and beneficiarios.i_funcionarios = funcionarios.i_funcionarios and beneficiarios.i_entidades = funcionarios.i_entidades 
and funcionarios.dt_admissao<=  rescisoes.dt_rescisao
