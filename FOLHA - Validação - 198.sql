...
select distinct
    ...
    where  
        funcionarios.i_entidades = tabAlt.entidade and --funcionarios.i_funcionarios = 60  and 
...
select i_entidades,i_cargos,dataAlteracao,i_niveis from ajusta_198;